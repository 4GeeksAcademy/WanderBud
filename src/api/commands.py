    ...
    def insert_test_data():
        ...
        try:
            ...
            events = [
                        ...
                        Event(owner=users[0], name="Arsawa Concert", location="Wizink Center, Madrid, Spain", start_datetime=datetime.datetime(year=2024, month=8, day=20, hour=21), end_datetime=datetime.datetime(year=2024, month=8, day=20, hour=23), status="Planned", description="Concert by the indie rock band", budget_per_person=30.0, event_type=event_types[4], latitude=40.4168, longitude=-3.7038),
                        Event(owner=users[0], name="Picasso Exhibition", location="Picasso Museum, Barcelona, Spain", start_datetime=datetime.datetime(year=2024, month=9, day=25, hour=10), end_datetime=datetime.datetime(year=2024, month=9, day=25, hour=12), status="Planned", description="Exhibition of the artist's masterpieces", budget_per_person=15.0, event_type=event_types[13], latitude=41.3851, longitude=2.1734),
                        Event(owner=users[0], name="Football Match", location="Santiago Bernabéu Stadium, Madrid, Spain", start_datetime=datetime.datetime(year=2024, month=10, day=30, hour=19), end_datetime=datetime.datetime(year=2024, month=10, day=30, hour=21), status="Planned", description="League match between Real Madrid and FC Barcelona", budget_per_person=40.0, event_type=event_types[6], latitude=40.4530, longitude=-3.6883),
                        Event(owner=users[1], name="Halloween Party", location="Joy Eslava Nightclub, Madrid, Spain", start_datetime=datetime.datetime(year=2024, month=11, day=30, hour=23), end_datetime=datetime.datetime(year=2024, month=11, day=1, hour=6), status="Planned", description="Halloween-themed party with music and dancing", budget_per_person=25.0, event_type=event_types[7], latitude=40.4150, longitude=-3.7074),
                        Event(owner=users[1], name="Classic Theater Play", location="Teatro Real, Madrid, Spain", start_datetime=datetime.datetime(year=2024, month=12, day=15, hour=20), end_datetime=datetime.datetime(year=2024, month=12, day=15, hour=22), status="Planned", description="Performance of a classic theater play", budget_per_person=35.0, event_type=event_types[8], latitude=40.4180, longitude=-3.7113),
