            ...
            <div className="row justify-content-center">
                ...
                <div className="col-md-4">
                    <div className="card p-4" style={{ backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0px 2px 10px rgba(0, 0, 0, 0.1)' }}>
                        ...
                        <form>
                            <button type="submit" className="btn btn-primary btn-block rounded-pill mb-3">Login</button>
                        </form>
                        ...
                        {/* Botón de registro */}
                        <button type="submit" className="btn btn-light btn-block rounded-pill border" style={{ textDecoration: 'none' }}>Sign Up</button>
                    </div>
                </div>
            </div>
        </div>
